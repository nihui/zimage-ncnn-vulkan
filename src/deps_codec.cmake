...
if(NOT USE_SYSTEM_JPEG)
    ...
    add_dependencies(zimage-ncnn-vulkan deps-libjpeg-turbo)

    target_include_directories(zimage-ncnn-vulkan PRIVATE "${CMAKE_CURRENT_BINARY_DIR}/deps-install/${CMAKE_INSTALL_INCLUDEDIR}")
    target_link_directories(zimage-ncnn-vulkan PRIVATE "${CMAKE_CURRENT_BINARY_DIR}/deps-install/${CMAKE_INSTALL_LIBDIR}")
    if(WIN32)
...
if(NOT USE_SYSTEM_ZLIB)
    ...
    add_dependencies(zimage-ncnn-vulkan deps-zlib-ng)
...
if(NOT USE_SYSTEM_PNG)
    ...
    add_dependencies(zimage-ncnn-vulkan deps-libpng)
...
if(NOT USE_SYSTEM_WEBP)
    ...
    add_dependencies(zimage-ncnn-vulkan deps-libwebp)
